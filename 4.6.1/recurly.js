...
/***/ function(module, exports, __webpack_require__) {
	...
	function factory(options) {
	  options = _extends({}, options, { recurly: this });
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function factory(options) {
	  return new ApplePay(_extends({}, options, { recurly: this }));
	};
	...
	var BraintreeStrategy = exports.BraintreeStrategy = function (_PayPalStrategy) {
	  ...
	  _createClass(BraintreeStrategy, [{
	    ...
	    value: function start() {
	      ...
	      var tokenOpts = _extends({}, this.config.display, { flow: 'vault' });
	...
	var Bus = exports.Bus = function (_Emitter) {
	  ...
	  _createClass(Bus, [{
	    ...
	    value: function receiveFromRelay(message) {
	      ...
	      if (data) this.send(new _message.Message(data.recurly_event, data.recurly_message));
	    }
